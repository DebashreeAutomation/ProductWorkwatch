...
public class workflowForTestUser {
   ...
   public void ClickAction() {
	...
	public void accNumberNobtn(){
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(1000));
		WebElement supplierAccNum=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[3]/div[1]/div/div[2]/div/section/div[16]/div/div/div/div[1]/div[1]/div[2]/div[3]/div/div[2]/div/div/div/div/div[2]/div/div[3]/div[1]/div[2]/div/div/div[2]/div/div[2]/div[1]/div/div[3]/div[2]/div[2]/div/input")));	
		supplierAccNum.click();
	}
	public void currencyNobtn(){
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(1000));
